      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            <th class="bg-success"><img src="icons8-pakistan-48.png" alt="pk"></th>
            <th class="bg-success" scope="col">
              <h2>806</h2>
            </th>
        ...
        <tbody class="table-group-divider">
          <tr>
            <th scope="row">2</th>
            <td>INDIA </td>
            <td> <img src="icons8-india-48 (1).png" alt="ind"></td>
            <td>770</td>
          ...
          <tr>
            <th scope="row">3</th>
            <td>Australia</td>
            <td> <img src="icons8-australia-48.png" alt="aus"></td>
            <td>723</td>
          ...
          <tr>
            <th scope="row">4</th>
            <td>New zealand </td>
            <td><img src="icons8-new-zealand-48.png" alt="nz"> </td>
            <td>701</td>
          </tr>
          ...
          <tr>
            <th scope="row">5</th>
            <td>Saudi Arabia </td>
            <td><img src="icons8-saudi-arabia-48.png" alt="SAR"></td>
            <td>690</td>
          </tr>
          <tr>
            <th scope="row">6</th>
            <td>Lithuania </td>
            <td><img src="icons8-lithuania-48.png" alt="Li"></td>
            <td>660</td>
          </tr>
          <tr>
            <th scope="row">7</th>
            <td>Afghanistan</td>
            <td> <img src="icons8-afghanistan-flag-48.png" alt="afg"></td>
            <td>620</td>
          </tr>
          <tr>
            <th scope="row">8</th>
            <td>Mexico</td>
            <td> <img src="icons8-mexico-48.png" alt="mex"></td>
            <td>601</td>
          </tr>
          <tr>
            <th scope="row">9</th>
            <td>Canada</td>
            <td> <img src="icons8-canada-48.png" alt="can"></td>
            <td>590</td>
          </tr>
          <tr>
            <th scope="row">10</th>
            <td>Netherland</td>
            <td> <img src="icons8-netherlands-48.png" alt="ne"></td>
            <td>550</td>
          </tr>
      ...
      <table class="table">
        <thead>
          ...
          <tr>
            ...
            <th><img src="icons8-pakistan-48.png" alt="pk"></th>
            <th scope="col">
              <h2>806</h2>
            </th>
        ...
        <tbody class="table-group-divider">
          <tr>
            <th scope="row">2</th>
            <td>Virat Kohli </td>
            <td><img src="icons8-india-48 (1).png" alt="inr"></td>
            <td>770</td>
          ...
          <tr>
            <th scope="row">3</th>
            <td>SHADAB KHAN </td>
            <td><img src="icons8-pakistan-48.png" alt="pk"></td>
            <td>723</td>
          ...
          <tr>
            <th scope="row">4</th>
            <td>Ben Stokes</td>
            <td><img src="icons8-england-circular-48.png" alt="eng"> </td>
            <td>701</td>
          </tr>
          <tr>
            <th scope="row">4</th>
